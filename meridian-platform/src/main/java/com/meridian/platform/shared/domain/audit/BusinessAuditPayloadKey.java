...
public enum BusinessAuditPayloadKey {
    ...
    PARTNER_ELIGIBILITY_REVIEW_ID("partnerEligibilityReviewId", ValueType.UUID),
    PARTNER_EMPLOYEE_ID("partnerEmployeeId", ValueType.UUID),
    PARTNER_ELIGIBILITY_REVIEW_OUTCOME("partnerEligibilityReviewOutcome", ValueType.CODE),
    PARTNER_ELIGIBILITY_REVIEW_REASON("partnerEligibilityReviewReason", ValueType.CODE),

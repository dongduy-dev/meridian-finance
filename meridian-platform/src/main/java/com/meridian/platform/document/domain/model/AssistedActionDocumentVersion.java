...
public record AssistedActionDocumentVersion(
        UUID id,
        UUID assistedActionDocumentId,
        int versionNumber,
    ...
    public AssistedActionDocumentVersion {
        Objects.requireNonNull(id);
        Objects.requireNonNull(assistedActionDocumentId);
    ...
    public boolean sameLogicalUpload(
        ...
        return assistedActionDocumentId.equals(documentId)

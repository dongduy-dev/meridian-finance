...
public final class SensitiveDisbursementBankAccountDetails implements AutoCloseable {
    ...
    public SensitiveDisbursementBankAccountDetails(
    ...
    @Override public String toString() {
        return "SensitiveDisbursementBankAccountDetails[customerId=" + customerId

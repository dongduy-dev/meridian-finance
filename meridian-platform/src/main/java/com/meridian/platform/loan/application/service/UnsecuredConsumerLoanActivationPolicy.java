...
@Service
public class UnsecuredConsumerLoanActivationPolicy implements LoanProductActivationPolicy {

    private final UnsecuredConsumerLoanVerificationRepository verifications;

    public UnsecuredConsumerLoanActivationPolicy(
    ...
    public ProductCode supportedProduct() {
        return ProductCode.UNSECURED_CONSUMER_LOAN;
    }
    ...
    public ProductActivationResult activate(ProductActivationCommand command) {
        ...
        return ProductActivationResult.withoutExposureEffect(
    ...
    private static BusinessStateConflictException invalidVerification() {
        return new BusinessStateConflictException(
                ...
                "Unsecured Consumer Loan verification is not valid for activation."
        );
    }
    ...
    private static BusinessStateConflictException completedStateConflict() {
        return stateConflict("Completed Unsecured Consumer Loan activation evidence is inconsistent.");
    }
}

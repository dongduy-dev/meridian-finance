...
@Service
public class StartAssistedUnsecuredConsumerLoanService
        implements StartAssistedUnsecuredConsumerLoanUseCase {
    ...
    public StartAssistedUnsecuredConsumerLoanService(
        ...
        this.origination = new UnsecuredConsumerLoanOrigination(
                products, applications, checklists, verifications, customers,
                outstandingAccounts, transitions, audits);
    }
    ...
    public AssistedOriginationCaseDto submit(
        ...
        if (assistedCase.productCode() != ProductCode.UNSECURED_CONSUMER_LOAN) {
            throw new BusinessStateConflictException(
                    "ASSISTED_ORIGINATION_PRODUCT_MISMATCH",
                    "Assisted origination case is not eligible for UCL conversion.");
        }
        ...
        intakeEvidence.requireCurrentUclPaperApplication(assistedCase.id());
        ...
        UnsecuredConsumerLoanOrigination.Result result = origination.create(
                ...
                OriginationChannel.STAFF_ASSISTED, operation, now);

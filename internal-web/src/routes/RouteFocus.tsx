...
function routeTitle(pathname: string): string {
  ...
  if (pathname === '/staff/work/settlements') return 'Settlement work queue | Meridian'
  if (pathname === '/staff/work/closures') return 'Closure work queue | Meridian'
  ...
  if (/^\/staff\/applications\/[^/]+\/settlement$/.test(pathname)) return 'Administrative Full-Balance Settlement | Meridian'
  if (/^\/staff\/applications\/[^/]+\/closure$/.test(pathname)) return 'Administrative closure | Meridian'

...
describe('Admin route metadata', () => {
  it('defines the executable administration home, Partner, Loan Product, and Internal User routes', () => {
    ...
    expect(ADMIN_USERS_ROUTE.requiredPermissions).toEqual(['identity:user:manage'])
  })

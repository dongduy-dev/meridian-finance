...
- `/admin` is the capability-guarded Back-Office foundation. Unimplemented `/admin/*` children return the safe not-found page for authorized administrative actors and load no administration data.

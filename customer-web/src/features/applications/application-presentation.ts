...
const applicationStatuses: Record<string, StatusPresentation> = {
  ...
  RETURNED_FOR_REVISION: { label: 'Returned for revision', tone: 'warning', icon: PenLine },
  ...
  CUSTOMER_ACCEPTANCE_PENDING: { label: 'Customer acceptance pending', tone: 'warning', icon: CircleAlert },
